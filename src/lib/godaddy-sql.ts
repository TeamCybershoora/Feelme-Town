...
export const insertCompletedBooking = async (bookingData: any) => {
  try {
    ...
    // Use the original booking snapshot as the authoritative source so fields don't become NULL
    const sourceBooking = (bookingData?._originalBooking && typeof bookingData._originalBooking === 'object')
