      ...
      try {
        ...
        const completedRecord = {
          ...
          ...Object.keys(bookingData).reduce((acc: any, key: string) => {
            ...
            if (!['_id', 'compressedData', 'bookingId', 'id', 'name', 'email', 'phone', 
                  'theaterName', 'date', 'time', 'occasion', 'numberOfPeople', 
                  'totalAmount', 'advancePayment', 'venuePayment', 'status', 
                  'createdAt', 'occasionPersonName', 'bookingType', 'createdBy', 
                  'isManualBooking', 'staffId', 'staffName', 'notes',
                  'selectedMovies', 'selectedCakes', 'selectedDecorItems', 'selectedGifts'].includes(key)) {
