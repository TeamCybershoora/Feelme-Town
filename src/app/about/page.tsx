    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setCurrentImageIndex((prevIndex) => 
                prevIndex === theaterImages.length - 1 ? 0 : prevIndex + 1
            );
        }, 3000); // Change image every 3 seconds

        return () => clearInterval(interval);
    }, [theaterImages.length]);
                    ...
                    <div className="infinite-scroll-container">
                        <div className="infinite-scroll-track">
                            ...
                            <div className="image-wrapper image-1">
                                <div className="image-glow glow-1"></div>
                                <div className="image-container">
                                    <Image
                                        src="/images/theater1.webp"
                                        alt="Luxury Private Theater"
                                        width={600}
                                        height={400}
                            ...
                            <div className="image-wrapper image-2">
                                <div className="image-glow glow-2"></div>
                                <div className="image-container">
                                    <Image
                            ...
                            <div className="image-wrapper image-3">
                                <div className="image-glow glow-3"></div>
                                <div className="image-container">
                                    <Image
                                        src="/images/theater3.webp"
                                        alt="Modern Private Theater Experience"
                                        width={600}
                                        height={400}
                                        className="theater-image"
                                    />
                            ...
                            <div className="image-wrapper image-4">
                                <div className="image-glow glow-4"></div>
                                <div className="image-container">
                                    <Image
                                        src="/images/theater4.webp"
                                        alt="Elegant Private Cinema Setup"
                                        width={600}
                                        height={400}
                                        className="theater-image"
                                    />
