    ...
    try {
      ...
      const completedBookings = (completedArray).map((booking: any) => {
        ...
        return {
          ...
          bookingId: booking.booking_id || booking.bookingId || booking.bookingID,
          id: booking.booking_id || booking.bookingId || booking.bookingID,
      ...
      // Show all bookings
      const allBookingsToShow = allBookings;
