              ...
              <div className="detail-grid">
                ...
                <div className="detail-item">
                  ...
                  <span className="value payment-value-with-badge">
                    ₹{(booking.advancePayment || booking.pricingData?.slotBookingFee || 499).toLocaleString()}
                    {booking.advancePaymentMethod && (
                      <span className={`payment-method-badge ${String(booking.advancePaymentMethod).toLowerCase()}`}>
                        {String(booking.advancePaymentMethod).toUpperCase()}
                      </span>
                    )}
                  </span>
                </div>
